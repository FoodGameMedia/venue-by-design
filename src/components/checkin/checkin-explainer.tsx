  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
        ...
        how your venue is shifting, and keep the weekly loop going. Stuck on your scores? Ask{" "}
        <span className="font-medium text-foreground">Sebastian</span>, who answers from the Calm
        Venue method.
      </p>
