...
export function CheckinForm({
  ...
  if (result) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center bg-transparent px-4 py-8 sm:px-6">
  ...
  return (
    <div className="flex flex-1 flex-col bg-transparent px-4 py-8 sm:px-6">
